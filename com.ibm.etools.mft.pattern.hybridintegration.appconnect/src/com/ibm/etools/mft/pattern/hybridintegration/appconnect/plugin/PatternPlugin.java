 ...
 */
package com.ibm.etools.mft.pattern.hybridintegration.appconnect.plugin;
...
public class PatternPlugin extends Plugin {	
	public static final String PLUGIN_ID = "com.ibm.etools.mft.pattern.hybridintegration.appconnect"; //$NON-NLS-1$
